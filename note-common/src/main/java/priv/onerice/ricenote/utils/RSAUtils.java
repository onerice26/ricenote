...
public class RSAUtils {
    ...
    // cas 加密
    public static String encryption(String key, String password) throws Exception {
        ...
        RSAPublicKey publicKey = (RSAPublicKey) keyFactory.generatePublic(pkcs8EncodedKeySpec);
        Cipher cipher = Cipher.getInstance("RSA");
        cipher.init(Cipher.ENCRYPT_MODE, publicKey);
        byte[] encryptByte = cipher.doFinal(password.getBytes());
        return java.util.Base64.getEncoder().encodeToString(encryptByte);
